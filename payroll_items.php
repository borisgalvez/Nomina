			...
			<div class="col-lg-12">
				...
				<div class="card">
					<div class="card-header">
						...
						<button class="btn btn-primary btn-sm btn-block col-md-2 float-right" type="button" id="new_payroll_btn"><span class="fa fa-plus"></span> Recalcular nómina</button>
					</div>
					<div class="card-body">
						<div class="row">
							<div class="col-md-12">
							<p>Rango de nómina: <b><?php echo date("M d, Y",strtotime($pay['date_from'])). " - ".date("M d, Y",strtotime($pay['date_to'])) ?></b></p>
							<p>Tipo de nómina: <b><?php echo $pt[$pay['type']] ?></b></p>
