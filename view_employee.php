...
<div class="contriner-fluid">
	<div class="col-md-12">
		...
		<p><b>Posición : <?php echo ucwords($pname) ?></b></p>
		<hr class="divider">
		<div class="row">
			<div class="col-md-6">
				<div class="card">
					...
					<div class="card-body">
						<ul class="list-group">
						  ...
						  <li class="list-group-item d-flex justify-content-between align-items-center alist" data-id="<?php echo $row['id'] ?>">
						  	<span>
						    <p><small><?php echo $row['aname'] ?> Ingresos</small></p>
						    <p><small>Tipo: <?php echo $t_arr[$row['type']] ?></small></p>
						    <?php if($row['type'] == 3): ?>
						    <p><small>Fecha efectividad: <?php echo date("M d,Y",strtotime($row['effective_date'])) ?></small></p>
						    <?php endif; ?>
						    </span>
