...
<div class="contriner-fluid">
	<div class="col-md-12">
		...
		<div class="row">
			<div class="col-md-6">
				<p><b>Ref nómina : <?php echo $pay['ref_no'] ?></b></p>
				<p><b>Rango Nómina : <?php echo date("M d, Y",strtotime($pay['date_from'])). " - ".date("M d, Y",strtotime($pay['date_to'])) ?></b></p>
				<p><b>Tipo Nómina : <?php echo $pt[$pay['type']] ?></b></p>
			</div>
			<div class="col-md-6">
				<p><b>Dias Ausencias : <?php echo $absent ?></b></p>
				<p><b>Tardanzas (mins) : <?php echo $late ?></b></p>
				<p><b>Total Monto Ingresos : <?php echo number_format($allowance_amount,2) ?></b></p>
				<p><b>Total Monto Deducciones : <?php echo number_format($deduction_amount,2) ?></b></p>
				<p><b>Neto a pagar : <?php echo number_format($net,2) ?></b></p>
			</div>
		</div>
				...
				<div class="card">
					...
					<div class="card-body">
						<ul class="list-group">
						   ...
						   <?php echo $all_arr[$val->aid] ?> Ingresos
