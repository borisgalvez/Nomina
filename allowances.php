						...
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="text-center">Información Ingreso</th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										 ...
										 <p class="truncate"><small>Descripción: <b><?php echo $row['description'] ?></b></small></p>
									</td>
									<td class="text-center">
										...
										<button class="btn btn-sm btn-danger delete_allowances" type="button" data-id="<?php echo $row['id'] ?>">Borrar</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
